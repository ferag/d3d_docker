...
RUN svn checkout https://svn.oss.deltares.nl/repos/delft3d/tags/6075/ delft3d_repository --username <user> --password <pass>
...
RUN cd delft3d_repository/examples/01_standard && ./run_flow2d3d.sh && ls
